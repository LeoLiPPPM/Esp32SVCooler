...
This code is not functional. Use for reference only. Including both WifiManager and BluetoothSerial requires too much memory. Use one or the other, and not both at once. 
